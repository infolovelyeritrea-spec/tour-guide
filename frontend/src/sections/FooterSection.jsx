const contactLinks = [
  ...
  },
  {
    ...
    detail: "Lovely Eritrea"
  }
];

function FooterSection({ id, aboutTitle, aboutText, contactTitle, contactDetails }) {
  return (
      ...
      <div className="footer-panel footer-contact-panel">
        ...
        <div className="contact-list">
          {contactDetails.map((detail) => (
            <div className="contact-detail-card" key={detail}>
              <span className="contact-detail-dot" aria-hidden="true"></span>
              <p>{detail}</p>
            </div>
          ))}
        </div>
